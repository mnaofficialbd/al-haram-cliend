    ...
    return (
        <section className='px-4'>
            ...
            <div className="d-flex justify-content-center">
                <div><button className="details-btn">Add Adult</button></div>
                <div><button className="details-btn">Add Seats</button></div>
                <div><button className="details-btn">Add Meals</button></div>
                <div><button className="details-btn">Add Bagagge</button></div>
            </div>
