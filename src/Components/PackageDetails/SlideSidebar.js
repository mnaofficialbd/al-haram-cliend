                ...
                <div className='rounded py-3'>
                        <div className='p-3' >
                            ...
                            <div>
                                ...
                                <select class="sidebar_select_btn mt-2 form-select form-select-lg mb-4" aria-label=".form-select-lg example" style={{ color: '#757575', fontSize: '20px' }}>
                            ...
                            <div className='bg-white d-flex justify-content-between mb-4 px-4 align-items-center rounded sidebar_select_btn' >
                                <div>
                                    <p className='m-0' style={{ color: '#757575', fontSize: '20px' }}>Per Person</p>
                                </div>
                                <div>
