                    ...
                    <div className='my-5 mx-5'>
                        <div className='px-3' >
                            <div>
                                ...
                                <select class="sidebar_select_btn form-select form-select-lg mb-3" aria-label=".form-select-lg example" style={{ color: '#757575', fontSize: '20px' }}>
                            ...
                            <div>
                                ...
                                <select class="sidebar_select_btn mt-2 form-select form-select-lg mb-3" aria-label=".form-select-lg example" style={{ color: '#757575', fontSize: '20px' }}>
                                    <option selected>Luxury</option>
                                    <option value="1">Simple</option>
                                    <option value="2">VIP</option>
                                </select>
                            </div>
                            <div className='bg-white d-flex justify-content-between mb-3 px-4 align-items-center rounded sidebar_select_btn' >
                                <div>
                            ...
                            <div className='mt-3'>
                                <button className='package_details_btn sidebar_select_btn font-bold'>
                                    Make An Enquiry
                                </button>
                            </div>
                            <div className='mt-3'>
