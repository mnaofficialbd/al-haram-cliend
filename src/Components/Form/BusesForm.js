            ...
            <div className="row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
                <div className='col'>
                    <div className="d-flex">
                        ...
                        <label htmlFor="exampleInputDeparture" className="form-label ms-2 font-semibold font-uppercase">FROM</label>
                    </div>
                ...
                <div className='col'>
                    <div className="d-flex">
                        ...
                        <label htmlFor="exampleInputDeparture" className="form-label font-semibold ms-2">TO</label>
                    </div>
                    <input type="text" placeholder='Eg: 1 Oct 2022' className="form-control" />
                </div>
                <div className='col'>
                    <div className="d-flex">
                        <span className="">
                        ...
                        <label htmlFor="exampleInputDeparture" className="form-label ms-2 font-semibold">DATE OF TRAVEL</label>
                    </div>
                ...
                <div className='col'>
                    <div className="d-flex">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 384 512"><path d="M169.4 470.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 370.8 224 64c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 306.7L54.6 265.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" /></svg>
                        </span>
                        <label htmlFor="exampleInputDeparture" className="form-label ms-2 font-semibold">PASSENGERS</label>
                    </div>
