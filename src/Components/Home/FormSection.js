            ...
            <form action="" className='bg-white p-4'>
                <div className="row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
                    <div className='col'>
                        <div className="d-flex">
                            ...
                            <label htmlFor="exampleInputDeparture" className="form-label ms-2 font-uppercase">COUNTRY</label>
                        </div>
                    ...
                    <div className='col'>
                        <div className="d-flex">
                            ...
                            <label htmlFor="exampleInputDeparture" className="form-label ms-2">CITY</label>
                        </div>
                    ...
                    <div className='col'>
                        <div className="d-flex">
                            ...
                            <label htmlFor="exampleInputDeparture" className="form-label ms-2">DURATION</label>
                        </div>
                    ...
                    <div className='col'>
                        <div className="d-flex">
                            ...
                            <label htmlFor="exampleInputDeparture" className="form-label ms-2">TRAVEL DATE</label>
                        </div>
                ...
                <div className="d-md-flex justify-content-between align-items-center mt-4">
                    <div className="d-flex gap-2 align-items-center">
                        <div className='px-1'>
                            <label htmlFor="exampleInputDeparture" className="form-label">ADULT</label>
                        ...
                        <div className='px-1'>
                            <label htmlFor="exampleInputDeparture" className="form-label">CHILD(REN)</label>
                            <div className="input-group">
                                <button className="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04">
                                    <span className="font-bold">+</span>
                                </button>
                        ...
                        <div className='px-1'>
                            <label htmlFor="exampleInputDeparture" className="form-label ">INFANT(S)</label>
                            <div className="input-group">
                                <button className="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04">
                                    <span className="font-bold">+</span>
                                </button>
